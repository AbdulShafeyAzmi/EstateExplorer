        ...
        <div className="flex flex-col flex-1  gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="p-3 text-green-700 border border-green-700 hover:shadow-lg uppercase rounded disabled:opacity-80"
            >
            ...
            formData.imageUrls.map((url) => (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleDeleteImage(formData.imageUrls.indexOf(url))
                  }
